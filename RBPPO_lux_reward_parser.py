# Obs format (15 obs):
# [0. unit_pos_x, 1. unit_pos_y, 2. unit_type, 3. unit_power, 4. unit_ice, 5. unit_ore, 6. unit_team_id, 7. factory_pos_x, 8. factory_pos_y, 9. factory_ice, 10. factory_ore, 11. closest_ice_x, 12. closest_ice_y, 13. closest_ore_x, 14. closest_ore_y]

# Reward parser input params: prev_obs, new_obs, env?

# Creation steps:
# 1: Understand normalization of obs for proper utilization
